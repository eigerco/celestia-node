...
require (
	github.com/celestiaorg/go-fraud v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/agnivade/wasmbrowsertest v0.8.0 // indirect
...
replace (
	...
	github.com/celestiaorg/go-fraud => ./third_party/go-fraud // TODO remove eventually or disable only tracing
	github.com/celestiaorg/go-header => ./third_party/go-header // TODO remove eventually or disable only tracing
	...
	github.com/paralin/go-indexeddb v1.1.0 => github.com/eigerco/go-indexeddb v0.0.0-20240220124441-c5f0a94c409e
